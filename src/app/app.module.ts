...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forRoot([
      ...
      { path: 'request/list/:reqId', component: RequestListComponent /*, canActivate: [AuthGuard]  */},
      { path: 'request/summary/:reqId', component: RequestSummaryComponent /*, canActivate: [AuthGuard]  */},
      { path: 'login', component: LoginComponent },
      { path: 'recovery/:id', component: RecoveryDetailsComponent /*, canActivate: [AuthGuard]  */},
      { path: 'request/:reqId', component: RequestDetailsComponent /*, canActivate: [AuthGuard]  */},
    ])
  ],
  providers: [AuthGuard],
